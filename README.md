..
<h1 align="center">Hi, I'm Nandika ♾️ </h1>
...
```
Python · Java · Django · Flask · REST APIs · JavaScript · C · C++
```

**AI / ML**
```
LangChain · LLMs · RAG · Agentic AI · TensorFlow · PyTorch · Scikit-learn · OpenAI API · Vertex AI
```

**Cloud & DevOps**
```
AWS (Lambda, S3, EC2, IoT Greengrass) · Microsoft Azure · Google BigQuery
